  ...
  return (
    <div className='navbar'>
      ...
      <ul className='navbar-menu'>
        ...
        <a href='#footer' onClick={()=>setMenu("contact-us")} className={menu==="contact-us"?"active":""}>content us</a>
      </ul>
      <div className="navbar-right">
        ...
        :<div className="navbar-profile">
          ...
          <ul className="nav-profile-dropdown">
            <li onClick={()=>navigate('/myorders')}><img src={assets.bag_icon} alt={assets.bag_icon} /><p>Orders</p></li>
            <hr />
            <li onClick={logout}><img src={assets.logout_icon} alt={assets.logout_icon} /><p>Logout</p></li>
          </ul>
          </div>}
      </div>
    </div>
